...
def process_files(folder_path, ratios_base_dir):
    ...
    for filename in os.listdir(folder_path):
        if filename.endswith(".xlsx"):  # Ensure only Excel files are processed
            ...
            output_file = os.path.join(ratios_dir, f"ratios_{filename}")
...
if __name__ == "__main__":
    ...
    directories = ["/mounts/data/proj/molly/LLM_bias_analysis/EconoLex_data/c4ai-command-r7b-12-2024", "/mounts/data/proj/molly/LLM_bias_analysis/EconoLex_data/DeepSeek-R1-Distill-Llama-8B", "/mounts/data/proj/molly/LLM_bias_analysis/EconoLex_data/gemma-2-9b-it",
                   "/mounts/data/proj/molly/LLM_bias_analysis/EconoLex_data/GLM-4-9B-Chat", "/mounts/data/proj/molly/LLM_bias_analysis/EconoLex_data/llama_3.1_8B",
                   "/mounts/data/proj/molly/LLM_bias_analysis/EconoLex_data/Ministral-8B-Instruct-2410", "/mounts/data/proj/molly/LLM_bias_analysis/EconoLex_data/phi-4",
                   "/mounts/data/proj/molly/LLM_bias_analysis/EconoLex_data/Qwen2.5-7B-Instruct"]
    
    # Define the central ratios directory
    ratios_base_dir = "/mounts/data/proj/molly/LLM_bias_analysis/ratios"
